...
- When a task is ambiguous between "quick arcade prototype" and "production release pipeline" scope, default to matching what's already in the repo (this template ships a real, working — if minimal — skeleton) rather than gold-plating.
