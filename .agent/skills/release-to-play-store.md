...
For the iOS equivalent (App Store Connect), see [`docs/moon/roadmaps/ios.md`](../../moon/roadmaps/ios.md) — signing/export automation is not built yet; `just ios-archive` produces an unsigned `.xcarchive` as a starting point.
